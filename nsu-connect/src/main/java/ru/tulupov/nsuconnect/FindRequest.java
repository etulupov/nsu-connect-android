 ...
 */
public class FindRequest extends com.android.volley.toolbox.StringRequest {
    String uid;
    public FindRequest(int method, String url, Response.Listener<String> listener, Response.ErrorListener errorListener, String uid) {
        super(method, url, listener, errorListener);
        this.uid = uid;
    }

    public FindRequest(String url, Response.Listener<String> listener, Response.ErrorListener errorListener) {
